...
namespace DocworksCmsQA.Tests.OtherValidations.CreateProjectValidations
{
    ...
    [Parallelizable]
    class VerifyUserUnableToCreateProjectWithoutGivingRepoURLField : BeforeTestAfterTest
    {
        ...
        [Test, Description("Verifying that the user is unable to create project when the RepoUrl is not given")]
        public void TC50_VerifyUserUnableToCreateProjectWithoutGivingRepoURLField()
        {
            try
            {
                ...
                addProject.EnterDescription("This is to create Project without RepoUrl");
                String actual2 = addProject.GetText(addProject.MERCURIAL_REPO_PATH);
                addProject.SuccessScreenshot(addProject.MERCURIAL_REPO_PATH, "Validating the title name");
