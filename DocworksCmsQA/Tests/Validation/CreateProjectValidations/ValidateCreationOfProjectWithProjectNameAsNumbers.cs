...
namespace DocworksCmsQA.Tests.OtherValidations.CreateProjectValidation
{
    ...
    [Parallelizable]
    class ValidateCreationOfProjectWithProjectNameAsNumbers : BeforeTestAfterTest
    {
        ...
        [Test, Description("Verifying that the user is able to create project when the project name is given in numbers")]
        public void TC52_ValidateCreationOfProjectWithProjectNameAsNumbers()
        {
            try
            {
                ...
                // projectName = "4363648565";
                projectName = GenerateNumbers(5);
