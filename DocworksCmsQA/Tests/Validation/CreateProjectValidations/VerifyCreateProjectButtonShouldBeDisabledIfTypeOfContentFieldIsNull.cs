...
namespace DocworksCmsQA.Tests.OtherValidations.CreateProjectValidations
{
    ...
    [Parallelizable]
    class VerifyCreateProjectButtonShouldBeDisabledIfTypeOfContentFieldIsNull : BeforeTestAfterTest
    {
        ...
        [Test, Description("Verifying that the submit button should be disabled if the type of content field is null")]
        public void TC45_ValidateSubmitbuttonWithTOCasnull()
        {
            try
            {
